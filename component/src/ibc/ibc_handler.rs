...
/// only.
#[async_trait]
pub trait AppHandlerCheck: Send + Sync + StateRead {
...
#[async_trait]
pub trait AppHandlerExecute: Send + Sync + StateWrite {
...
impl AppHandlerCheck for AppRouter {
    async fn chan_open_init_check(&self, msg: &MsgChannelOpenInit) -> Result<()> {
        // TODO: use a match expression instead of the handlers mapping
