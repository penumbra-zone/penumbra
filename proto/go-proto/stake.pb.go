...
var file_stake_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x62, 0x69, 0x74, 0x76, 0x65, 0x63, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68,
...
var file_stake_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_stake_proto_goTypes = []interface{}{
	...
	(*Address)(nil),                        // 19: penumbra.crypto.Address
}
var file_stake_proto_depIdxs = []int32{
	18, // 0: penumbra.stake.Validator.identity_key:type_name -> penumbra.crypto.IdentityKey
	4,  // 1: penumbra.stake.Validator.funding_streams:type_name -> penumbra.stake.FundingStream
	18, // 2: penumbra.stake.ValidatorList.validator_keys:type_name -> penumbra.crypto.IdentityKey
	18, // 3: penumbra.stake.RateData.identity_key:type_name -> penumbra.crypto.IdentityKey
	18, // 4: penumbra.stake.ValidatorStatus.identity_key:type_name -> penumbra.crypto.IdentityKey
	...
	18, // 13: penumbra.stake.Delegate.validator_identity:type_name -> penumbra.crypto.IdentityKey
	18, // 14: penumbra.stake.Undelegate.validator_identity:type_name -> penumbra.crypto.IdentityKey
	19, // 15: penumbra.stake.CommissionAmount.destination:type_name -> penumbra.crypto.Address
