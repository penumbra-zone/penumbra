...
impl serde::Serialize for CurrentEpochRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("penumbra.view.v1alpha1.CurrentEpochRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CurrentEpochRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CurrentEpochRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.view.v1alpha1.CurrentEpochRequest")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<CurrentEpochRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
                ...
                Ok(CurrentEpochRequest {
                })
            }
        }
        deserializer.deserialize_struct("penumbra.view.v1alpha1.CurrentEpochRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CurrentEpochResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.view.v1alpha1.CurrentEpochResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for CurrentEpochResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CurrentEpochResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.view.v1alpha1.CurrentEpochResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<CurrentEpochResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(CurrentEpochResponse {
                    epoch: epoch__,
                })
            }
        }
        deserializer.deserialize_struct("penumbra.view.v1alpha1.CurrentEpochResponse", FIELDS, GeneratedVisitor)
    }
}
