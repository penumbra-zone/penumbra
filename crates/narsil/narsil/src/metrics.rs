...
pub const MEMPOOL_CHECKTX_TOTAL: &str = "penumbra_narsild_mempool_checktx_total";

pub const CLIENT_OBLIVIOUS_COMPACT_BLOCK_ACTIVE_CONNECTIONS: &str =
    "penumbra_narsild_oblivious_client_compact_active_connections";

pub const CLIENT_OBLIVIOUS_COMPACT_BLOCK_SERVED_TOTAL: &str =
    "penumbra_narsild_oblivious_client_compact_block_served_total";
