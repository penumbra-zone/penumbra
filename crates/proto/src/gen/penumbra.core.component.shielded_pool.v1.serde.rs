...
impl serde::Serialize for EventDenomRegistered {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.shielded_pool.v1.EventDenomRegistered", len)?;
        if let Some(v) = self.asset_id.as_ref() {
            struct_ser.serialize_field("assetId", v)?;
        }
        if let Some(v) = self.denom_metadata.as_ref() {
...
impl<'de> serde::Deserialize<'de> for EventDenomRegistered {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.shielded_pool.v1.EventDenomRegistered")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EventDenomRegistered, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut asset_id__ = None;
        ...
        deserializer.deserialize_struct("penumbra.core.component.shielded_pool.v1.EventDenomRegistered", FIELDS, GeneratedVisitor)
    }
}
