...
impl serde::Serialize for Effects {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.transaction.v1.Effects", len)?;
        if let Some(v) = self.address.as_ref() {
            struct_ser.serialize_field("address", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for Effects {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.transaction.v1.Effects")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<Effects, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("penumbra.core.transaction.v1.Effects", FIELDS, GeneratedVisitor)
    }
}
