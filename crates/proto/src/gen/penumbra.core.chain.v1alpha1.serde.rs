...
impl<'de> serde::Deserialize<'de> for Epoch {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.chain.v1alpha1.Epoch")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.chain.v1alpha1.Epoch", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GenesisCheckpoint {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for GenesisCheckpoint {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GenesisCheckpoint;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.chain.v1alpha1.GenesisCheckpoint")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<GenesisCheckpoint, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("penumbra.core.chain.v1alpha1.GenesisCheckpoint", FIELDS, GeneratedVisitor)
    }
}
