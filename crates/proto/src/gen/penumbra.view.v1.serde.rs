...
impl serde::Serialize for ComplianceLeaf {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.view.v1.ComplianceLeaf", len)?;
        if let Some(v) = self.address.as_ref() {
            struct_ser.serialize_field("address", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for ComplianceLeaf {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.view.v1.ComplianceLeaf")
            }
        ...
        deserializer.deserialize_struct("penumbra.view.v1.ComplianceLeaf", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ComplianceViewingKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.view.v1.ComplianceViewingKey", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for ComplianceViewingKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.view.v1.ComplianceViewingKey")
            }
        ...
        deserializer.deserialize_struct("penumbra.view.v1.ComplianceViewingKey", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MerklePath {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.view.v1.MerklePath", len)?;
        if !self.layers.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MerklePath {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.view.v1.MerklePath")
            }
        ...
        deserializer.deserialize_struct("penumbra.view.v1.MerklePath", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MerklePathLayer {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.view.v1.MerklePathLayer", len)?;
        if !self.siblings.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MerklePathLayer {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.view.v1.MerklePathLayer")
            }
        ...
        deserializer.deserialize_struct("penumbra.view.v1.MerklePathLayer", FIELDS, GeneratedVisitor)
    }
}
