impl serde::Serialize for ChainParametersRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.app.v1alpha1.ChainParametersRequest", len)?;
        if !self.chain_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ChainParametersRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.app.v1alpha1.ChainParametersRequest")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.app.v1alpha1.ChainParametersRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ChainParametersResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.app.v1alpha1.ChainParametersResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for ChainParametersResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.app.v1alpha1.ChainParametersResponse")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.app.v1alpha1.ChainParametersResponse", FIELDS, GeneratedVisitor)
    }
}
