...
impl serde::Serialize for TransactionId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.txhash.v1alpha1.TransactionId", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for TransactionId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.txhash.v1alpha1.TransactionId")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.txhash.v1alpha1.TransactionId", FIELDS, GeneratedVisitor)
    }
}
