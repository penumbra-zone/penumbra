...
pub mod participate_request {
    ...
    impl ::prost::Name for Identify {
        ...
        fn full_name() -> ::prost::alloc::string::String {
            "penumbra.tools.summoning.v1.ParticipateRequest.Identify".into()
        }
    ...
    impl ::prost::Name for Contribution {
        ...
        const PACKAGE: &'static str = "penumbra.tools.summoning.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "penumbra.tools.summoning.v1.ParticipateRequest.Contribution".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/penumbra.tools.summoning.v1.ParticipateRequest.Contribution".into()
        }
...
impl ::prost::Name for ParticipateRequest {
    ...
    const PACKAGE: &'static str = "penumbra.tools.summoning.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "penumbra.tools.summoning.v1.ParticipateRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/penumbra.tools.summoning.v1.ParticipateRequest".into()
    }
...
impl ::prost::Name for CeremonyCrs {
    ...
    const PACKAGE: &'static str = "penumbra.tools.summoning.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "penumbra.tools.summoning.v1.CeremonyCrs".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/penumbra.tools.summoning.v1.CeremonyCrs".into()
    }
...
impl ::prost::Name for CeremonyLinkingProof {
    ...
    const PACKAGE: &'static str = "penumbra.tools.summoning.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "penumbra.tools.summoning.v1.CeremonyLinkingProof".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/penumbra.tools.summoning.v1.CeremonyLinkingProof".into()
    }
...
impl ::prost::Name for CeremonyParentHashes {
    ...
    const PACKAGE: &'static str = "penumbra.tools.summoning.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "penumbra.tools.summoning.v1.CeremonyParentHashes".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/penumbra.tools.summoning.v1.CeremonyParentHashes".into()
    }
...
pub mod participate_response {
    ...
    impl ::prost::Name for Position {
        ...
        const PACKAGE: &'static str = "penumbra.tools.summoning.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "penumbra.tools.summoning.v1.ParticipateResponse.Position".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/penumbra.tools.summoning.v1.ParticipateResponse.Position".into()
        }
    ...
    impl ::prost::Name for Confirm {
        ...
        const PACKAGE: &'static str = "penumbra.tools.summoning.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "penumbra.tools.summoning.v1.ParticipateResponse.Confirm".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/penumbra.tools.summoning.v1.ParticipateResponse.Confirm".into()
        }
...
impl ::prost::Name for ParticipateResponse {
    ...
    const PACKAGE: &'static str = "penumbra.tools.summoning.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "penumbra.tools.summoning.v1.ParticipateResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/penumbra.tools.summoning.v1.ParticipateResponse".into()
    }
...
pub mod ceremony_coordinator_service_server {
    ...
    #[async_trait]
    pub trait CeremonyCoordinatorService: std::marker::Send + std::marker::Sync + 'static {
    ...
    /// Runs a Phase 2 MPC ceremony with dynamic slot allocation.
    #[derive(Debug)]
    pub struct CeremonyCoordinatorServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> CeremonyCoordinatorServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for CeremonyCoordinatorServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "penumbra.tools.summoning.v1.CeremonyCoordinatorService";
    impl<T> tonic::server::NamedService for CeremonyCoordinatorServiceServer<T> {
