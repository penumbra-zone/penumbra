impl serde::Serialize for ClientConnections {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.ibc.v1alpha1.ClientConnections", len)?;
        if !self.connections.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ClientConnections {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.ClientConnections", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for ClientCounter {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.ClientCounter", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ClientData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.ibc.v1alpha1.ClientData", len)?;
        if !self.client_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ClientData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.ClientData", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for ConnectionCounter {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.ConnectionCounter", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ConsensusState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.ibc.v1alpha1.ConsensusState", len)?;
...
impl<'de> serde::Deserialize<'de> for ConsensusState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.ConsensusState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FungibleTokenPacketData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.ibc.v1alpha1.FungibleTokenPacketData", len)?;
        if !self.denom.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FungibleTokenPacketData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.FungibleTokenPacketData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.ibc.v1alpha1.GenesisContent", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for IbcRelay {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.ibc.v1alpha1.IbcRelay", len)?;
...
impl<'de> serde::Deserialize<'de> for IbcRelay {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.ibc.v1alpha1.IbcRelay")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.IbcRelay", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Ics20Withdrawal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.ibc.v1alpha1.Ics20Withdrawal", len)?;
...
impl<'de> serde::Deserialize<'de> for Ics20Withdrawal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.Ics20Withdrawal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VerifiedHeights {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.ibc.v1alpha1.VerifiedHeights", len)?;
        if !self.heights.is_empty() {
...
impl<'de> serde::Deserialize<'de> for VerifiedHeights {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.core.component.ibc.v1alpha1.VerifiedHeights", FIELDS, GeneratedVisitor)
    }
}
