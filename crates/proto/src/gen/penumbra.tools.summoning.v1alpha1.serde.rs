...
impl<'de> serde::Deserialize<'de> for CeremonyLinkingProof {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.CeremonyLinkingProof", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for CeremonyParentHashes {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.CeremonyParentHashes", FIELDS, GeneratedVisitor)
    }
}
