...
impl<'de> serde::Deserialize<'de> for CeremonyCrs {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.CeremonyCrs", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ParticipateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateRequest", len)?;
...
;
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_request::Contribution {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.update_proof.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateRequest.Contribution", len)?;
        if let Some(v) = self.updated.as_ref() {
            struct_ser.serialize_field("updated", v)?;
        }
        if !self.update_proof.is_empty() {
            struct_ser.serialize_field("updateProof", pbjson::private::base64::encode(&self.update_proof).as_str())?;
        }
        struct_ser.end()
    }
}
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "updateProof" | "update_proof" => Ok(GeneratedField::UpdateProof),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::UpdateProof => {
                            if update_proof__.is_some() {
                                return Err(serde::de::Error::duplicate_field("updateProof"));
                            }
                            update_proof__ = 
                                Some(map.next_value::<::pbjson::private::BytesDeserialize<_>>()?.0)
                            ;
                ...
                Ok(participate_request::Contribution {
                    updated: updated__,
                    update_proof: update_proof__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateRequest.Contribution", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_request::Identify {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateRequest.Identify", len)?;
...
impl<'de> serde::Deserialize<'de> for participate_request::Identify {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateRequest.Identify", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ParticipateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateResponse", len)?;
        if let Some(v) = self.msg.as_ref() {
            match v {
...
;
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for participate_response::Confirm {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateResponse.Confirm", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_response::ContributeNow {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateResponse.ContributeNow", len)?;
...
impl<'de> serde::Deserialize<'de> for participate_response::ContributeNow {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateResponse.ContributeNow", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for participate_response::Position {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateResponse.Position", len)?;
        if self.position != 0 {
...
impl<'de> serde::Deserialize<'de> for participate_response::Position {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.tools.summoning.v1alpha1.ParticipateResponse.Position", FIELDS, GeneratedVisitor)
    }
}
