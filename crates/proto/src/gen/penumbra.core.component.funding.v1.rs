...
/// Request if a nullifier is already used in the current epoch.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct LqtCurrentEpochVotedRequest {
    /// The nullifier to check.
    #[prost(message, optional, tag = "1")]
    pub nullifier: ::core::option::Option<super::super::sct::v1::Nullifier>,
}
impl ::prost::Name for LqtCurrentEpochVotedRequest {
    const NAME: &'static str = "LqtCurrentEpochVotedRequest";
...
impl ::prost::Name for LqtCurrentEpochVotedResponse {
    const NAME: &'static str = "LqtCurrentEpochVotedResponse";
    const PACKAGE: &'static str = "penumbra.core.component.funding.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "penumbra.core.component.funding.v1.LqtCurrentEpochVotedResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/penumbra.core.component.funding.v1.LqtCurrentEpochVotedResponse".into()
    }
...
pub mod distributions_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn lqt_current_epoch_voted(
            &mut self,
            request: impl tonic::IntoRequest<super::LqtCurrentEpochVotedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LqtCurrentEpochVotedResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod distributions_service_server {
    ...
    pub trait DistributionsService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn lqt_current_epoch_voted(
            &self,
            request: tonic::Request<super::LqtCurrentEpochVotedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LqtCurrentEpochVotedResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/penumbra.core.component.funding.v1.DistributionsService/LqtCurrentEpochVoted" => {
                    ...
                    let fut = async move {
                        let method = LqtCurrentEpochVotedSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
