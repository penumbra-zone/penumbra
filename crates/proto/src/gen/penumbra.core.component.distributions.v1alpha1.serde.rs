impl serde::Serialize for DistributionsParameters {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.distributions.v1alpha1.DistributionsParameters", len)?;
        if self.staking_issuance_per_block != 0 {
...
impl<'de> serde::Deserialize<'de> for DistributionsParameters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.distributions.v1alpha1.DistributionsParameters")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.distributions.v1alpha1.DistributionsParameters", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.distributions.v1alpha1.GenesisContent", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.distributions.v1alpha1.GenesisContent")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.distributions.v1alpha1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
