...
impl serde::Serialize for FeeTier {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.fee.v1alpha1.FeeTier", len)?;
        if self.fee_tier != 0 {
...
impl<'de> serde::Deserialize<'de> for FeeTier {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.fee.v1alpha1.FeeTier")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.fee.v1alpha1.FeeTier", FIELDS, GeneratedVisitor)
    }
}
