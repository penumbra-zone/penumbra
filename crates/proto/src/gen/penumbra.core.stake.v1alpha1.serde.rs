impl serde::Serialize for BaseRateData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.BaseRateData", len)?;
        if self.epoch_index != 0 {
...
impl<'de> serde::Deserialize<'de> for BaseRateData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.BaseRateData")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<BaseRateData, V::Error>
                where
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.BaseRateData", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for BondingState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.BondingState")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<BondingState, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.BondingState", FIELDS, GeneratedVisitor)
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                ...
                i32::try_from(v)
                    .ok()
                    .and_then(bonding_state::BondingStateEnum::from_i32)
                    .ok_or_else(|| {
...
impl serde::Serialize for bonding_state::UnbondingEpoch {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.BondingState.UnbondingEpoch", len)?;
        if self.epoch != 0 {
...
impl<'de> serde::Deserialize<'de> for bonding_state::UnbondingEpoch {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = bonding_state::UnbondingEpoch;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.BondingState.UnbondingEpoch")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<bonding_state::UnbondingEpoch, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(bonding_state::UnbondingEpoch {
                    epoch: epoch__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.BondingState.UnbondingEpoch", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CurrentConsensusKeys {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.CurrentConsensusKeys", len)?;
        if !self.consensus_keys.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CurrentConsensusKeys {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.CurrentConsensusKeys")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<CurrentConsensusKeys, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.CurrentConsensusKeys", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Delegate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.Delegate", len)?;
...
impl<'de> serde::Deserialize<'de> for Delegate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.Delegate")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<Delegate, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::ValidatorIdentity => {
                            ...
                            validator_identity__ = map.next_value()?;
                        }
                        GeneratedField::EpochIndex => {
                            if epoch_index__.is_some() {
                                return Err(serde::de::Error::duplicate_field("epochIndex"));
                        ...
                        GeneratedField::DelegationAmount => {
                            ...
                            delegation_amount__ = map.next_value()?;
                        }
                    }
                }
                Ok(Delegate {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.Delegate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DelegationChanges {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.DelegationChanges", len)?;
        if !self.delegations.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DelegationChanges {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.DelegationChanges")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<DelegationChanges, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.DelegationChanges", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Penalty {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.Penalty", len)?;
        if self.inner != 0 {
...
impl<'de> serde::Deserialize<'de> for Penalty {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.Penalty")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<Penalty, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.Penalty", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RateData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.RateData", len)?;
...
impl<'de> serde::Deserialize<'de> for RateData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.RateData")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<RateData, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.RateData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Undelegate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.Undelegate", len)?;
        if let Some(v) = self.validator_identity.as_ref() {
            struct_ser.serialize_field("validatorIdentity", v)?;
        }
        if self.start_epoch_index != 0 {
...
impl<'de> serde::Deserialize<'de> for Undelegate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.Undelegate")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<Undelegate, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut validator_identity__ = None;
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.Undelegate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UndelegateClaim {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.UndelegateClaim", len)?;
...
impl<'de> serde::Deserialize<'de> for UndelegateClaim {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.UndelegateClaim")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<UndelegateClaim, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut body__ = None;
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.UndelegateClaim", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UndelegateClaimBody {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.UndelegateClaimBody", len)?;
        if let Some(v) = self.validator_identity.as_ref() {
            struct_ser.serialize_field("validatorIdentity", v)?;
        }
        if self.start_epoch_index != 0 {
...
impl<'de> serde::Deserialize<'de> for UndelegateClaimBody {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.UndelegateClaimBody")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<UndelegateClaimBody, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut validator_identity__ = None;
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.UndelegateClaimBody", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for UndelegateClaimPlan {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.UndelegateClaimPlan")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<UndelegateClaimPlan, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut validator_identity__ = None;
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.UndelegateClaimPlan", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Uptime {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.Uptime", len)?;
        if self.as_of_block_height != 0 {
...
impl<'de> serde::Deserialize<'de> for Uptime {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.Uptime")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<Uptime, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.Uptime", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Validator {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.Validator", len)?;
        if let Some(v) = self.identity_key.as_ref() {
            struct_ser.serialize_field("identityKey", v)?;
        }
        if !self.consensus_key.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Validator {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.Validator")
            }
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::FundingStreams => {
                            ...
                            funding_streams__ = Some(map.next_value()?);
                        }
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.Validator", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValidatorDefinition {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.ValidatorDefinition", len)?;
...
impl<'de> serde::Deserialize<'de> for ValidatorDefinition {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.ValidatorDefinition")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ValidatorDefinition, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.ValidatorDefinition", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValidatorInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.ValidatorInfo", len)?;
        if let Some(v) = self.validator.as_ref() {
            struct_ser.serialize_field("validator", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for ValidatorInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.ValidatorInfo")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.ValidatorInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValidatorList {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.ValidatorList", len)?;
        if !self.validator_keys.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ValidatorList {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.ValidatorList")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ValidatorList, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::ValidatorKeys => {
                            ...
                            validator_keys__ = Some(map.next_value()?);
                        }
                    }
                }
                Ok(ValidatorList {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.ValidatorList", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValidatorState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.ValidatorState", len)?;
        if self.state != 0 {
            let v = validator_state::ValidatorStateEnum::from_i32(self.state)
                .ok_or_else(|| serde::ser::Error::custom(format!("Invalid variant {}", self.state)))?;
            struct_ser.serialize_field("state", &v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ValidatorState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.ValidatorState")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ValidatorState, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut state__ = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::State => {
                            ...
                            state__ = Some(map.next_value::<validator_state::ValidatorStateEnum>()? as i32);
                        }
                    }
                }
                Ok(ValidatorState {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.ValidatorState", FIELDS, GeneratedVisitor)
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                ...
                i32::try_from(v)
                    .ok()
                    .and_then(validator_state::ValidatorStateEnum::from_i32)
                    .ok_or_else(|| {
                        serde::de::Error::invalid_value(serde::de::Unexpected::Signed(v), &self)
                    })
            }
...
impl serde::Serialize for ValidatorStatus {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.stake.v1alpha1.ValidatorStatus", len)?;
        if let Some(v) = self.identity_key.as_ref() {
            struct_ser.serialize_field("identityKey", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for ValidatorStatus {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.stake.v1alpha1.ValidatorStatus")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ValidatorStatus, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut identity_key__ = None;
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::BondingState => {
                            ...
                            bonding_state__ = map.next_value()?;
                        }
                    }
                }
                Ok(ValidatorStatus {
        ...
        deserializer.deserialize_struct("penumbra.core.stake.v1alpha1.ValidatorStatus", FIELDS, GeneratedVisitor)
    }
}
