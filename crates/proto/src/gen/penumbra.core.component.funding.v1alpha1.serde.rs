impl serde::Serialize for FundingParameters {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("penumbra.core.component.funding.v1alpha1.FundingParameters", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for FundingParameters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.funding.v1alpha1.FundingParameters")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.funding.v1alpha1.FundingParameters", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.funding.v1alpha1.GenesisContent", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.funding.v1alpha1.GenesisContent")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.funding.v1alpha1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
