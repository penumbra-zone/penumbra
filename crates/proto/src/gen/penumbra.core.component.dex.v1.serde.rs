...
impl serde::Serialize for PositionOpen {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.encrypted_metadata.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("encryptedMetadata", pbjson::private::base64::encode(&self.encrypted_metadata).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PositionOpen {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "position" => Ok(GeneratedField::Position),
                            "encryptedMetadata" | "encrypted_metadata" => Ok(GeneratedField::EncryptedMetadata),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            {
                let mut position__ = None;
                let mut encrypted_metadata__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Position => {
                            if position__.is_some() {
                        ...
                        GeneratedField::EncryptedMetadata => {
                            if encrypted_metadata__.is_some() {
                                return Err(serde::de::Error::duplicate_field("encryptedMetadata"));
                            }
                            encrypted_metadata__ = 
                                Some(map_.next_value::<::pbjson::private::BytesDeserialize<_>>()?.0)
                            ;
                        }
                        GeneratedField::__SkipField__ => {
                ...
                Ok(PositionOpen {
                    position: position__,
                    encrypted_metadata: encrypted_metadata__.unwrap_or_default(),
                })
            }
        }
...
impl serde::Serialize for PositionOpenPlan {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.dex.v1.PositionOpenPlan", len)?;
        if let Some(v) = self.position.as_ref() {
            struct_ser.serialize_field("position", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for PositionOpenPlan {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PositionOpenPlan;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.dex.v1.PositionOpenPlan")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PositionOpenPlan, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut position__ = None;
        ...
        deserializer.deserialize_struct("penumbra.core.component.dex.v1.PositionOpenPlan", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PositionOpenView {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.position_open_view.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.dex.v1.PositionOpenView", len)?;
        if let Some(v) = self.position_open_view.as_ref() {
            match v {
                position_open_view::PositionOpenView::Visible(v) => {
                    struct_ser.serialize_field("visible", v)?;
                }
                position_open_view::PositionOpenView::Opaque(v) => {
...
impl<'de> serde::Deserialize<'de> for PositionOpenView {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PositionOpenView;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.dex.v1.PositionOpenView")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PositionOpenView, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut position_open_view__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Visible => {
                            if position_open_view__.is_some() {
                                return Err(serde::de::Error::duplicate_field("visible"));
                            }
                            position_open_view__ = map_.next_value::<::std::option::Option<_>>()?.map(position_open_view::PositionOpenView::Visible)
;
                        }
                        GeneratedField::Opaque => {
                            ...
                            position_open_view__ = map_.next_value::<::std::option::Option<_>>()?.map(position_open_view::PositionOpenView::Opaque)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                ...
                Ok(PositionOpenView {
                    position_open_view: position_open_view__,
                })
            }
        }
        deserializer.deserialize_struct("penumbra.core.component.dex.v1.PositionOpenView", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for position_open_view::Opaque {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.dex.v1.PositionOpenView.Opaque", len)?;
...
impl<'de> serde::Deserialize<'de> for position_open_view::Opaque {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = position_open_view::Opaque;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.dex.v1.PositionOpenView.Opaque")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<position_open_view::Opaque, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(position_open_view::Opaque {
                    action: action__,
                })
            }
        }
        deserializer.deserialize_struct("penumbra.core.component.dex.v1.PositionOpenView.Opaque", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for position_open_view::Visible {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.dex.v1.PositionOpenView.Visible", len)?;
        if let Some(v) = self.action.as_ref() {
            struct_ser.serialize_field("action", v)?;
        }
        if let Some(v) = self.metadata.as_ref() {
...
impl<'de> serde::Deserialize<'de> for position_open_view::Visible {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = position_open_view::Visible;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.dex.v1.PositionOpenView.Visible")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<position_open_view::Visible, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut action__ = None;
                ...
                Ok(position_open_view::Visible {
                    action: action__,
                    metadata: metadata__,
                })
            }
        }
        deserializer.deserialize_struct("penumbra.core.component.dex.v1.PositionOpenView.Visible", FIELDS, GeneratedVisitor)
    }
}
