...
impl serde::Serialize for Proposal {
        ...
        S: serde::Serializer,
    {
        ...
        if self.unplanned_ibc_upgrade.is_some() {
            len += 1;
        }
        ...
        if let Some(v) = self.unplanned_ibc_upgrade.as_ref() {
            struct_ser.serialize_field("unplannedIbcUpgrade", v)?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "unplannedIbcUpgrade" | "unplanned_ibc_upgrade" => Ok(GeneratedField::UnplannedIbcUpgrade),
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut unplanned_ibc_upgrade__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::UnplannedIbcUpgrade => {
                            if unplanned_ibc_upgrade__.is_some() {
                                return Err(serde::de::Error::duplicate_field("unplannedIbcUpgrade"));
                            }
                            unplanned_ibc_upgrade__ = map_.next_value()?;
                        }
                ...
                Ok(Proposal {
                    ...
                    unplanned_ibc_upgrade: unplanned_ibc_upgrade__,
...
impl serde::Serialize for proposal::UnplannedIbcUpgrade {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.governance.v1alpha1.Proposal.UnplannedIbcUpgrade", len)?;
        if !self.connection_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for proposal::UnplannedIbcUpgrade {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = proposal::UnplannedIbcUpgrade;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.governance.v1alpha1.Proposal.UnplannedIbcUpgrade")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<proposal::UnplannedIbcUpgrade, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(proposal::UnplannedIbcUpgrade {
                    connection_id: connection_id__.unwrap_or_default(),
                    new_config: new_config__,
                })
            }
        }
        deserializer.deserialize_struct("penumbra.core.component.governance.v1alpha1.Proposal.UnplannedIbcUpgrade", FIELDS, GeneratedVisitor)
    }
}
