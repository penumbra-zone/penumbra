...
impl<'de> serde::Deserialize<'de> for BindingSignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.crypto.decaf377_rdsa.v1alpha1.BindingSignature", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for SpendAuthSignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.crypto.decaf377_rdsa.v1alpha1.SpendAuthSignature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SpendVerificationKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.crypto.decaf377_rdsa.v1alpha1.SpendVerificationKey", len)?;
        if !self.inner.is_empty() {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("inner", pbjson::private::base64::encode(&self.inner).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for SpendVerificationKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.crypto.decaf377_rdsa.v1alpha1.SpendVerificationKey")
            }
        ...
        deserializer.deserialize_struct("penumbra.crypto.decaf377_rdsa.v1alpha1.SpendVerificationKey", FIELDS, GeneratedVisitor)
    }
}
