...
impl serde::Serialize for CompactBlockRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.compact_block.v1alpha1.CompactBlockRequest", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for CompactBlockRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.compact_block.v1alpha1.CompactBlockRequest")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.compact_block.v1alpha1.CompactBlockRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CompactBlockResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.compact_block.v1alpha1.CompactBlockResponse", len)?;
        if let Some(v) = self.compact_block.as_ref() {
            struct_ser.serialize_field("compactBlock", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for CompactBlockResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.compact_block.v1alpha1.CompactBlockResponse")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.compact_block.v1alpha1.CompactBlockResponse", FIELDS, GeneratedVisitor)
    }
}
