...
impl<'de> serde::Deserialize<'de> for MerklePathChunk {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.crypto.tct.v1alpha1.MerklePathChunk", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for MerkleRoot {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.crypto.tct.v1alpha1.MerkleRoot", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for StateCommitment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.crypto.tct.v1alpha1.StateCommitment", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StateCommitmentProof {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.crypto.tct.v1alpha1.StateCommitmentProof", len)?;
...
impl<'de> serde::Deserialize<'de> for StateCommitmentProof {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("penumbra.crypto.tct.v1alpha1.StateCommitmentProof", FIELDS, GeneratedVisitor)
    }
}
