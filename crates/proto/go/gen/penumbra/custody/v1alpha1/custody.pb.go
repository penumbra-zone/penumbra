...
func (x *AuthorizeRequest) GetAccountId() *v1alpha11.AccountID {
	if x != nil {
		return x.AccountId
	}
	return nil
...
var file_penumbra_custody_v1alpha1_custody_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x80, 0x02, 0x0a, 0x10, 0x41, 0x75, 0x74, 0x68, 0x6f,
	...
	0x70, 0x6c, 0x61, 0x6e, 0x12, 0x47, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x70, 0x65, 0x6e, 0x75, 0x6d,
	...
	0x49, 0x44, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x5a, 0x0a,
...
var file_penumbra_custody_v1alpha1_custody_proto_goTypes = []interface{}{
	...
	(*v1alpha11.AccountID)(nil),        // 5: penumbra.core.crypto.v1alpha1.AccountID
...
var file_penumbra_custody_v1alpha1_custody_proto_depIdxs = []int32{
	...
	5, // 1: penumbra.custody.v1alpha1.AuthorizeRequest.account_id:type_name -> penumbra.core.crypto.v1alpha1.AccountID
