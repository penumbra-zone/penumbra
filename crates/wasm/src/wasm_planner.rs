...
impl WasmPlanner {
    pub fn memo_inner(&mut self, memo: JsValue) -> WasmResult<()> {
    ...
    pub fn output_inner(&mut self, value: JsValue, address: JsValue) -> WasmResult<()> {
    ...
    pub async fn swap_claim_inner(&mut self, swap_commitment: JsValue) -> WasmResult<()> {
