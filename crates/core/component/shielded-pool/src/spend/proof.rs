...
mod tests {
    ...
    proptest! {
    #[test]
    /// Check that the `SpendProof` is not satisified when using an incorrect
    /// TCT root (`anchor`).
    ...
    proptest! {
        #[test]
        /// Check that the `SpendProof` is not satisified when the diversified address is wrong.
    ...
    proptest! {
        #[test]
        /// Check that the `SpendProof` is not satisified, when using an
        /// incorrect nullifier.
    ...
    proptest! {
        #[test]
        /// Check that the `SpendProof` is not satisifed when using balance
    ...
    proptest! {
        #[test]
        /// Check that the `SpendProof` is not satisfied when the incorrect randomizable verification key is used.
