    ...
    Event::new(
        ...
        vec![
            ...
            (
                ...
                .index(),
            ("packet_sequence", packet.seq_on_a.to_string()).index(),
            ("packet_src_port", packet.port_id_on_a.to_string()).index(),
            ("packet_src_channel", packet.chan_id_on_a.to_string()).index(),
            ("packet_dst_port", packet.port_id_on_b.to_string()).index(),
            ("packet_dst_channel", packet.chan_id_on_b.to_string()).index(),
