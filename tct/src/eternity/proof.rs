...
pub struct Proof<Hasher: hash::Hasher>(pub(super) crate::proof::Proof<Eternity<Hasher>, Hasher>);
...
impl<Hasher: hash::Hasher> Proof<Hasher> {
    ...
    pub fn auth_path(&self) -> [&[Hash<Hasher>; 3]; 24] {
        use crate::internal::path::{Leaf, Node};
